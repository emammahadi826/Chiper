            ...
            builder: (context, child) {
              ...
              return MaterialApp(
                ...
                theme: ThemeData(
                  ...
                  textTheme: TextTheme(
                    displayLarge: GoogleFonts.merriweather(color: Colors.black, fontSize: 60.sp, fontWeight: FontWeight.w300),
                    displayMedium: GoogleFonts.roboto(color: Colors.black.withOpacity(0.6), fontSize: 30.sp),
                    bodyLarge: GoogleFonts.roboto(color: Colors.black, fontSize: 28.sp, fontWeight: FontWeight.w500),
                    bodyMedium: GoogleFonts.roboto(color: Colors.black.withOpacity(0.7), fontSize: 18.sp),
                  ),
                  ...
                  colorScheme: const ColorScheme.light(
                    primary: Colors.blue, // Blue for primary actions
                                  ...
                                  onSecondary: Colors.black,                    surface: Colors.white, // White for general surfaces
                ...
                darkTheme: ThemeData(
                  ...
                  textTheme: TextTheme(
                    displayLarge: GoogleFonts.merriweather(color: Colors.white, fontSize: 60.sp, fontWeight: FontWeight.w300),
                    displayMedium: GoogleFonts.roboto(color: Colors.white.withOpacity(0.6), fontSize: 30.sp),
                    bodyLarge: GoogleFonts.roboto(color: Colors.white, fontSize: 28.sp, fontWeight: FontWeight.w500),
                    bodyMedium: GoogleFonts.roboto(color: Colors.white.withOpacity(0.7), fontSize: 18.sp),
                  ),
